...
import BgBase from '../../../public/static/1/New/harapan.png'
                    ...
                    <div className="flex flex-col justify-center z-10 font-[montserrat] mx-5 my-5">
                        <div className="flex flex-col w-full p-5 pb-8 z-50">
                            ...
                            <div className="flex justify-center pt-5">
                                {(name === '' || commentText === '') ?
                                    <button disabled onClick={addComment} className="bg-[#2a5d87] bg-opacity-25 w-[200px] h-[30px] font-bold text-sm rounded-full text-white border-[1px] border-black">
                                        Disabled
                                    </button> :
