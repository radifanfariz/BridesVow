...
import BgBase from "../../../public/static/6/album-bg.png"
        ...
        <section className="relative">
            ...
            <AnimationOnScroll animateOnce={false} animateIn="animate__fadeInUpBig">
                ...
                <div className="flex flex-col justify-around h-[600px] relative">
                    <div className="px-10">
                        <div className="flex justify-center text-2xl font-[poppins] mt-10 text-white bg-[#763B13] rounded-full">Galeri Foto</div>
                    </div>
