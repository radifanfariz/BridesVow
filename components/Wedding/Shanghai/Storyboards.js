...
import Road from '../../../public/static/6/storyboards-road.svg'
    ...
    return (
        <section className="relative">
            ...
            <AnimationOnScroll animateOnce={false} animateIn="animate__fadeInUpBig">
                <div className="flex flex-col h-full min-h-screen relative overflow-hidden min-w-full ">
                    <div className="flex justify-center pt-10 pb-3 z-10">
                        <div className="bg-[#763B13] rounded-full px-16 font-bold z-10 text-white text-2xl font-[poppins]">Perjalanan Cinta</div>
                    </div>
                    <div className="absolute w-full h-full max-h-[575px] top-36 lg:right-16 lg:top-[9rem] right-2 z-50">
                    ...
                    <div className="flex flex-col px-10 z-10 relative">
                        <div className="flex mt-5 relative top-14 right-0">
                            <div className="flex flex-col">
                                <div className="flex justify-center relative">
                                    <div className="flex items-center text-xs text-black w-[380px] min-h-[170px] font-['montserrat'] p-5 relative -left-10 bg-white rounded-r-full shadow-xl">
                                        ...
                                        <div className="flex justify-center items-center w-10 h-10 rounded-full bg-[#E18601]">
                        ...
                        <div className="flex relative top-[4.5rem] right-0">
                            <div className="flex flex-col">
                                <div className="flex justify-center relative">
                        ...
                        <div className="flex pb-16 relative top-[5.5rem] right-0">
                            <div className="flex flex-col">
                                <div className="flex justify-center relative">
                                    <div className="flex items-center text-xs text-black w-[380px] min-h-[170px] font-['montserrat'] p-5 relative -left-10 bg-white rounded-r-full shadow-xl">
                                        <span className="w-[300px] text-right pr-5 max-h-[130px] overflow-auto">{contents.perjalanan1}</span>
