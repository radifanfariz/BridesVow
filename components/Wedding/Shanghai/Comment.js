    ...
    return (
        <div className="bg-white">
            <div className="flex border-t-[1px] border-black w-full px-5 py-4">
                <div className="w-[20px] h-[20px] rounded-full bg-[#50290F]"></div>
                <div className="flex flex-col px-2">
                    <div className="flex flex-col">
                        <div className="flex text-xs">
                            <span className="font-extrabold text-[#50290F]">
                                {name}
                            </span>
                        </div>
                ...
                <div className="flex justify-center items-center my-20 ml-5">
                    ...
                    <div className="flex flex-col items-center mb-72">
                        <div className="flex justify-center mt-8 z-10">
                            <div className="bg-[#50290F] rounded-full px-5 font-bold z-10 text-white text-2xl font-[poppins]">Harapan dan Doa Restu</div>
                        </div>
