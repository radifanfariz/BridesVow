...
import Bunga from '../../../public/static/6/intro-frame.png'
import BgBase from '../../../public/static/6/intro-bg.png'
                        ...
                        <div className="relative">
                            <div className="flex flex-col pb-56 xl:pb-[33rem]">
                                <div className="flex justify-center relative bottom-24 pt-20">
                                    <div className="bg-[#763B13] rounded-full px-16 font-bold z-10 text-white text-2xl font-[poppins]">Calon Pengantin</div>
                                </div>
                                <div className="relative">
