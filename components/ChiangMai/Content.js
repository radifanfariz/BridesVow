                            ...
                            <div className="flex flex-col bottom-10">
                                ...
                                <div className="relative">
                                    <div className="flex justify-center p-28 pb-20">
                                        <div className="relative">
                                            <Image layout="fixed" priority='true' className="rounded-full" src={Woman.src} alt='avatar' width={200} height={200} objectFit='cover' objectPosition='top' />
                                        </div>
                                    ...
                                    <div className="flex flex-col z-10">
                                        ...
                                        <div className="flex flex-col font-[montserrat]">
                                            ...
                                            <div className="flex justify-center text-center">'
                                                <div className="flex justify-center text-black w-[70%]">putri dari Garox Panjaitan dan Mamank Pasaribu</div>
                                            </div>
                                        </div>
                                        <div className="flex justify-center">
                                ...
                                <div className="relative">
                                    <div className="flex justify-center p-28 pb-20 pt-0">
                                        <div className="relative">
                                            <Image layout="fixed" priority='true' className="rounded-full" src={Man.src} alt='avatar' width={200} height={200} objectFit='cover' objectPosition='top' />
                                        </div>
                                        <div className="absolute">
                                            <div className="relative top-[120px] left-[-80px] rotate-[64deg] transform-gpu">
                                                <Image priority='true' className="" src={Bunga.src} alt='bunga' width={132} height={82} />
