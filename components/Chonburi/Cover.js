    ...
    return (
        ...
        <div className="flex flex-col h-full min-h-screen justify-center">
            ...
            <div className="flex z-10 justify-center items-center pt-5">
                <div className="font-bold text-7xl text-center text-white font-[richard]">{"Pulan & Pulin"}</div>
            </div>
            ...
            <div className="flex justify-center z-10">
                <button className="bg-[#000000] w-[185px] h-[36px] hover:opacity-25 p-2 m-5 mt-4 rounded-full text-white border-[1px] border-black" onClick={animateHeader}>
