    ...
    return (
        <>
            <div className="relative xl:w-full w-full h-full">
                <div style={{ backgroundImage: `url('/static/landing/longfiturbg.png')`, backgroundRepeat: 'no-repeat', backgroundSize: 'cover', backgroundPosition: 'center' }} className="flex justify-center w-full max-w-[600px] xl:h-full xl:max-h-[100%] xl:max-w-[100%] h-[28vh] max-h-[28vh] mt-8 p-6 py-3 rounded-3xl">
